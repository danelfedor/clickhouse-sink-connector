...
public class ClickHouseDbConstants {
    ...
    public static final String CLUSTER_STR = "'/clickhouse/tables/{uuid}/{shard}', '{replica}'";
    ...
    public static final String STORAGE_POLICY = " SETTINGS storage_policy = 'policy_1', allow_nullable_key = 1";
}
